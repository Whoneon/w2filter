...
Source, proofs (\texttt{docs/proofs.md}), validation targets and CI
configuration are distributed with this note. External dependency:
\texttt{nauty} (B.~D. McKay) for graph generation.
